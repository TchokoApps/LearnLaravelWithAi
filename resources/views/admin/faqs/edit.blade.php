            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Update FAQ Information</h5>
                    </div><!-- end card header -->
                        ...
                        <form action="{{ route('faqs.update', $faq->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror"
                                       value="{{ old('title', $faq->title) }}" placeholder="e.g., Real-Time Expense Tracking" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description" name="description" rows="5" class="form-control @error('description') is-invalid @enderror"
                                          placeholder="Enter the FAQ description..." required>{{ old('description', $faq->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="border-top pt-3 mt-3">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i data-feather="save" class="me-1" style="height: 16px; width: 16px;"></i>Update FAQ
                                    </button>
